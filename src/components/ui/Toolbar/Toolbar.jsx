...
function Toolbar({showAppWindow, showCardDetails, launchButtonStartSelected, buttonLaunch_selecedLabel, buttonLaunch_Label,
                  addNewBackup, toogleCheckAllbCards, toggleCheckAll, toolbar_showDeleteIcon, deleteSelectedBackup})
{
  return(
    <div className={classNames('Toolbar ', {'Toolbar--active': showAppWindow & !showCardDetails , '' : !showAppWindow })}>
      ...
      <div className="functionButton-container dFlex">
        ...
        <button className={classNames('functionButton button-selectAllBackups', {'button-selectAllBackups--active': toogleCheckAllbCards})} onClick={toggleCheckAll} >
        { toogleCheckAllbCards? <Icon name="selectAllDashed-checked" color="" size={20} /> : <Icon name="selectAllDashed" color="" size={20} />}
        </button>
